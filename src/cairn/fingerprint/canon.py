...
artifact, the P3/P4 probes in docs/project/PROJECT.md §4.4). Both live here because
...
def canonical_json(obj: Any) -> bytes:
    ...
    fingerprinting hash — see docs/project/PROJECT.md §4.2's work_key definition."""
...
def canonical_float32_bytes(arr: npt.ArrayLike) -> bytes:
    ...
    docs/project/PROJECT.md P3/P4 probes are defined as "compare sha256 of the
